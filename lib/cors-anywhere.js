...
function proxyRequest(req, res, proxy) { 
  ...
  let headers = { host: location.host };
  if (req.url.includes('dl.v.vrv.co') || location.host.includes('dl.v.vrv.co')) {
    console.log(headers);
    headers['Host'] = 'dl.v.vrv.co';
    headers['Connection'] = 'keep-alive';
    headers['Cache-Control'] = 'max-age=0';
    headers['Upgrade-Insecure-Requests'] = '1';
    headers['User-Agent'] = 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/87.0.4280.88 Safari/537.36 OPR/73.0.3856.284';
